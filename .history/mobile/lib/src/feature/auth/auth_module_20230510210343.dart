...
class authModule extends Module {
  static const AUTH_ROUTE = "/singleton";
...
class AuthSingletonModule extends Module {
  ...
  @override
  List<Bind<Object>> get binds => [Bind.singleton((i) => AuthViewmodel())];

  @override
  List<ModularRoute> get routes => [
        ChildRoute(ONE_PAGE, child: (_, __) => const LoginPage()),
        ChildRoute(TWO_PAGE, child: (_, __) => const SignUpPage()),
        ChildRoute(THREE_PAGE, child: (_, __) => const ForgotPassPage())
      ];
}
